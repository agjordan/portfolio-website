...
`;
let matterhorn = `<svg width="1440" height="1076" viewBox="0 0 1440 1076" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0)">
...
function displayNextMountain() {
  if (nextMountain < mountainsArr.length - 1) {
    nextMountain += 1;
  } else {
    nextMountain = 0;
  }

  document.getElementById("mountains").innerHTML = mountainsArr[nextMountain];
}

function previousMountains() {}
